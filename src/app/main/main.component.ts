...
export class MainComponent implements OnInit {
  ...
  topics: string[] = ["The meaning of life", "Dutch rap music", "The dangers of AI", "How many backflips could a cat do if it tried", "Should we colonize Mars"];
  currentTopic: string = "";
  ...
  sendMessage(message: string) {
    ...
    //
    let promptToSend = this.currentPrompt + this.promptMessage.replace("<MESSAGE>", message);
